<p align="center">
  ...
  <p align="center">
    ...
    <img src="https://img.shields.io/badge/platform-macOS%2026%2B-lightgrey?style=flat-square" alt="Platform" />
...
- Python 3 — installed via Xcode Command Line Tools or [Homebrew](https://brew.sh)
...
| `mlx-community/Qwen2.5-7B-Instruct-4bit` | ~4 GB | Balanced quality and speed |
| `mlx-community/Mistral-7B-Instruct-v0.3-4bit` | ~4 GB | General purpose |
...
- macOS 26 or later is required. Earlier versions are not supported.
